...
const Contact = () => {
  return (
    <div name='contact' className=' w-full  h-100 pt-20 bg-black flex flex-col justify-center items-center p-4 '>
        ...
        className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
                ...
                <p className='text-gray-300 py-8'>Submit the form below or shoot me an email - agostinaboris@protonmail.com</p>
            </div>
