...
//         </div>
//         <div>
//             <p className="text-2xl">I am passionate about building software that improves the lives of those around me. Together, we can create transformative solutions that address your unique needs and drive your success forward. Let's embark on this exciting journey of innovation and collaboration.
//             </p>
//         </div>
//         <div className="grid sm:grid-cols-1 w-full h-full justify-center items-center  pl-20">
//           <img src={YO} width={360} height={480} alt="/" className="rounded-full"></img>
//         </div>
//     </div>
//     </div>
//     </div>
